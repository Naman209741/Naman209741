...
### 🔐 Cybersecurity | ☁️ Cloud Computing | 🐍 Python | 💻 BCA Student

I'm a BCA student interested in **Cybersecurity, Cloud Computing, Networking, and Python**.

I'm currently building my technical skills through hands-on projects, labs, and continuous learning. My goal is to develop practical cybersecurity skills and eventually work in the cybersecurity industry.
...
![Cybersecurity](https://img.shields.io/badge/Cybersecurity-111111?style=for-the-badge\&logo=kalilinux\&logoColor=white)
...
| ------------------------- | --------------------------------- | ----------- |
| 🔐 Cybersecurity Projects | Security-focused Python projects  | 🟡 Building |
| 🌐 Networking Labs        | Networking & security experiments | 🟡 Learning |
| ☁️ AWS Cloud Labs         | AWS fundamentals & cloud security | 🟡 Learning |
| 🐍 Python Projects        | Automation & security utilities   | 🟡 Building |
...
* ✅ Started building my GitHub portfolio
* 📚 Strengthening Python fundamentals
* 📚 Learning networking & cybersecurity
* ☁️ Learning AWS fundamentals
...
**GitHub:** [@Naman209741](https://github.com/Naman209741)
